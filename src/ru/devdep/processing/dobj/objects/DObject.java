...
public class DObject extends Observable implements Observer,
	...
	public DObject( PApplet p ) {
		this.setApplet( p );
		this.children = new ArrayList<DObject>();
	}
	...
	public void appendChild( DObject child ) {
	...
	public void removeChild( DObject child ) {
	...
	public Boolean containsChild( DObject child ) {
		return children.contains( child );
	}

	public ArrayList<DObject> getChildren() {
		return children;
	}
